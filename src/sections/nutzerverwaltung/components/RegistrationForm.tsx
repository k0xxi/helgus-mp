...
import type { RegistrationFormProps, SocialProvider, PasswordStrength } from '@/../product/sections/nutzerverwaltung/types'
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-3 pt-2">
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              ...
              required
              disabled={isLoading}
              className="mt-0.5 w-4 h-4 text-red-600 bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-600 rounded focus:ring-red-500 focus:ring-2"
            />
        ...
        <button
          type="submit"
          disabled={isLoading || !acceptedTerms || !acceptedPrivacy || !passwordsMatch}
